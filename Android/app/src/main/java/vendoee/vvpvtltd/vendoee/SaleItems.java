...
public class SaleItems {
    ...
    public SaleItems(String itemName, double itemSalePrice, double itemOriginalPrice, String saleStartDate, String saleEndDate,
    ...
    public SaleItems(String itemName, double itemSalePrice, double itemOriginalPrice, String saleStartDate, String saleEndDate, String itemDesc, Bitmap itemThumbnail, int offerId, int selleerId, String itemCategory, String itemSubCategory, String shopName, String telephone, String lat, String lng, int cash, int verify, String vc, String dist, String like, String text) {
        this.itemName = itemName;
        this.itemSalePrice = itemSalePrice;
        this.itemOriginalPrice = itemOriginalPrice;
        this.saleStartDate = saleStartDate;
