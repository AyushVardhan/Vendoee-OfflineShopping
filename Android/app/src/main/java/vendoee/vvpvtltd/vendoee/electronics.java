...
public class electronics extends Fragment {
    ...
    DatabaseHelper myDB;
    Cursor res;private boolean loadin;
    TextView notify;
    String city,state;
    boolean isInserted;
    View rootView;
    ...
    LinearLayout weak; Button weak1;
    private boolean checkForNext = true;

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        rootView=inflater.inflate(R.layout.activity_electronics,container,false);
        myDB = new DatabaseHelper(getContext());
        load = (RelativeLayout) rootView.findViewById(R.id.loadingPanel);
        recyclerView=(RecyclerView)rootView.findViewById(R.id.recycler_view0);
        ...
        if(res.getCount()>0){
            RecyclerView recyclerView=(RecyclerView)rootView.findViewById(R.id.recycler_view0);
            ...
            while (res.moveToNext()){
                ...
                //Toast.makeText(getContext(),res.getString(14)+" "+res.getString(15),Toast.LENGTH_SHORT).show();
            ...
            public void onScrolled(RecyclerView recyclerView, int dx, int dy) {
                if (recyclerView.getAdapter().getItemCount() >= 3) {
                    ...
                    if (  loadin == false && lastVisibleItemPosition != RecyclerView.NO_POSITION && lastVisibleItemPosition == recyclerView.getAdapter().getItemCount() - 1)
                    {
                        ...
                        res = myDB.getItemDetailsfIX("Electronics",last_id,2);
                        int c = res.getCount();
                        if(res.getCount()>0){
                            if(checkForNext==true){
                            ...
                            while(res.moveToNext()){
                                ...
                                //int distance= (int)distance(latitude,longitude,Double.parseDouble(res.getString(14)),Double.parseDouble(res.getString(15)));
                                /*
                            ...
                            int c1 = recyclerView.getAdapter().getItemCount();

                            loadOffersID(city,c1);
    ...
    private void loadOffersID(final String city, final int c1) {
                    ...
                    public void onResponse(String response) {
                        ...
                        if (result.matches(str)) {
                            ...
                            if(isInserted){
                                ...
                                if(count!=0){
                                    recyclerView.scrollToPosition(c1 - count);
                                }else{
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, "http://vendoee.com/android-scripts/offerSales2E.php",
                            ...
                            if (result.isEmpty()) {
                                ...
                                if(cnt>0){
                                    ...
                                    while (res.moveToNext()){
                                        ...
                                        //Toast.makeText(getContext(),parsedDistance+" "+res.getString(2),Toast.LENGTH_SHORT).show();
                                        if(cash.equals("1"))
                                        {
                                            SaleItems a=new SaleItems(res.getString(2),res.getDouble(6),res.getDouble(5),res.getString(7),res.getString(8),res.getString(10),bitmap,res.getInt(0),res.getInt(1),res.getString(3),res.getString(4),res.getString(9),res.getString(14),res.getString(15),res.getString(16),getResources().getIdentifier("ic_credit_card_black_24dp", "drawable", getActivity().getPackageName()),res.getString(17),String.valueOf(parsedDistance),res.getString(18),"Cashless");
                                            saleItemsList.add(a);
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        //Toast.makeText(getContext(),"Load Electronics- "+ error.toString(),Toast.LENGTH_LONG).show();
                    }
                }){
            @Override
            protected Map<String,String> getParams(){
