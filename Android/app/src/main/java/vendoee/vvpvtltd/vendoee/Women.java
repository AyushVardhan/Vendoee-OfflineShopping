...
public class Women extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        rootView=inflater.inflate(R.layout.activity_women,container,false);
        ...
        mSwipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
                                                     ...
                                                     public void onRefresh() {
                                                         ...
                                                         //Toast.makeText(getContext(),"NoData refresh",Toast.LENGTH_SHORT).show();
                                                         loadOffers(city);
        ...
        res = myDB.getItemDetails("Women");
        int c5 = res.getCount();
        if(res.getCount()>0){
            RecyclerView recyclerView=(RecyclerView)rootView.findViewById(R.id.recycler_view3);
            //Toast.makeText(getContext(),"women-GotData",Toast.LENGTH_SHORT).show();
            saleItemsList=new ArrayList<>();
            adapter=new SaleItemsAdapter(rootView.getContext(), saleItemsList);
            ...
            public void onScrolled(RecyclerView recyclerView, int dx, int dy) {
                if (recyclerView.getAdapter().getItemCount() >= 3) {
                    ...
                    if ( loadin == false && lastVisibleItemPosition != RecyclerView.NO_POSITION && lastVisibleItemPosition == recyclerView.getAdapter().getItemCount() - 1)
                    {
                        ...
                        res = myDB.getItemDetailsfIX("Women",last_id,2);
                        int c = res.getCount();
                        if(res.getCount()>0){
                            //Toast.makeText(rootView.getContext(), "got in local", Toast.LENGTH_SHORT).show();
                            if(checkForNext==true){
                            ...
                            while(res.moveToNext()){
                                ...
                                //Toast.makeText(rootView.getContext(), "Local Scroll fetch: "+ res.getString(2), Toast.LENGTH_SHORT).show();
                                if(cash.equals("1"))
                                {
                                    SaleItems a=new SaleItems(res.getString(2),res.getDouble(6),res.getDouble(5),res.getString(7),res.getString(8),res.getString(10),bitmap,res.getInt(0),res.getInt(1),res.getString(3),res.getString(4),res.getString(9),res.getString(14),res.getString(15),res.getString(16),getResources().getIdentifier("ic_credit_card_black_24dp",  "drawable", getActivity().getPackageName()),res.getString(17),String.valueOf(parsedDistance),res.getString(18),"Cashless");
                                    saleItemsList.add(a);
                            ...
                            if(isInserted){
                                ...
                                if(res.getCount()>0){
                                    while(res.moveToNext()){
                                        ...
                                        //Toast.makeText(rootView.getContext(), "Remote Scroll fetch: "+ res.getString(2), Toast.LENGTH_SHORT).show();
                                        if(cash.equals("1"))
                                        {
                                            SaleItems a=new SaleItems(res.getString(2),res.getDouble(6),res.getDouble(5),res.getString(7),res.getString(8),res.getString(10),bitmap,res.getInt(0),res.getInt(1),res.getString(3),res.getString(4),res.getString(9),res.getString(14),res.getString(15),res.getString(16),getResources().getIdentifier("ic_credit_card_black_24dp",  "drawable", getActivity().getPackageName()),res.getString(17),String.valueOf(parsedDistance),res.getString(18),"Cashless");
                                            saleItemsList.add(a);
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        if (result.isEmpty()) {
                            ...
                            StringTokenizer str1 = new StringTokenizer(result,";"); int cnt = str1.countTokens();
                            while (str1.hasMoreTokens()) {
                                //Toast.makeText(chooser.this, str1.nextToken(), Toast.LENGTH_SHORT).show();
                                StringTokenizer str2 = new StringTokenizer(str1.nextToken(),"||");
