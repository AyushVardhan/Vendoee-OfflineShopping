<?php
	...
	define('DB','vendoe');
        ...
        try {
               ...
               $sth = $conn->prepare("SELECT * FROM offers WHERE seller_id = $sid");
  ...
  while($result = $sth->fetchObject()) {
      ...
      if($sth6->execute())
      {
		...
		$viewCount = $result6["hit_count"];
      	...
      	echo $shop."||";
      	echo $img."||"; echo $dis."||"; echo $lat."||"; echo $lng."||"; echo $contact."||"; echo $cash."||"; echo $verified."||"; echo $viewCount."||"; echo $sid.";";
          }
        }
    } 
            }
