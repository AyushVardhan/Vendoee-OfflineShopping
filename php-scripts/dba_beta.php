...
$sth = $conn->prepare("UPDATE sellers SET name='$name',owner_name='$bname',email='$email',username='$uname',password='$password',description='$description',image=:image,cashless='$cashless',delivery='$deliver',opening_time='$shopopen',closing_time='$shopclose',brand='$brand' WHERE id=$pin");
...
$sth = $conn->prepare("INSERT INTO sellers(name,owner_name,email,username,password,description,image,cashless,delivery,opening_time,closing_time,brand)VALUES(:name,:bname,:email,:uname,:password,:description,:image,:cash,:deliver,:shopopen,:shopclose,:brand)");
