  ...
  while($result = $sth->fetchObject()) {
      ...
      if($sth6->execute())
      {
		...
		$viewCount = $result6["hit_count"];
      	...
      	echo $shop."||"; echo $desc."||";
      	echo $img."||"; echo $dis."||"; echo $lat."||"; echo $lng."||"; echo $contact."||"; echo $cash."||"; echo $viewCount."||"; echo $love.";";
